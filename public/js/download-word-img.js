...
document.addEventListener('click', async function (e) {
    if (!e.target.closest('#generate-image')) return;

    const fontSize = document.getElementById('image-font-size').value || "12";
    const font = document.getElementById('image-font-style').value || "Arial";
...
document.addEventListener('click', function (e) {
    if (!e.target.closest('#generate-word')) return;

    const fontSize = document.getElementById('word-font-size').value || "12";
    const font = document.getElementById('word-font-style').value || "Arial";
