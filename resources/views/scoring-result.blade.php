...
<div class="preview-area">
    <a href="/preview"><button class="btn-return">Return</button></a>
    <div class="top">
        <h2>Evaluation Results</h2>
        <p>Detailed scoring for {{ $score->student_name }}'s submission</p>
    </div>
    
    <div class="generated-are-con">
        <div class="score-result-area">
            <div class="sr-header">
                <h2>{{ $score->student_name }}</h2>
            ...
            <div class="question-breakdown">
                ...
                @foreach($score->questionScores as $qs)
                   ...
                   @php
                        // Don't remove question number — keep full text
                        $cleaned_text = $question->question_text;

                        // Extract question text (before A), B), etc.)
...
document.addEventListener('click', async function (e) {
    if (e.target.closest('#dl-pdf-prev')) {
        const element = document.querySelector('.score-result-area');
